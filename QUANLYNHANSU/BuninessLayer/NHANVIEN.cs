...
namespace BuninessLayer
{
    public class NHANVIEN
    {
        ...
        // khởi tạo một đối tượng đại diện cho kết nối tới cơ sở dữ liệu và cung cấp các phương thức để thực hiện các thao tác truy vấn, thêm, sửa, xóa dữ liệu.
        ...
        public NHANVIEN_DTO getItemFull(int id)
        {
            ...
            NHANVIEN_DTO nvDTO= new NHANVIEN_DTO();
                ...
                var tg = db.tb_TONGIAO.FirstOrDefault(g => g.ID == item.IDPB);
